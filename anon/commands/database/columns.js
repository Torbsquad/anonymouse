...
command.funct = async (bot, message, args) => {
  let results = await pg.any(`SELECT column_name, data_type FROM information_schema.columns WHERE table_schema='public' and table_name=$1`, args)
